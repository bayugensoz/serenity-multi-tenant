...
using MyRepository = SerenMulti.Northwind.Repositories.TerritoryRepository;
using MyRow = SerenMulti.Northwind.Entities.TerritoryRow;

namespace SerenMulti.Northwind.Endpoints
{
    [Route("Services/Northwind/Territory/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class TerritoryController : ServiceEndpointMultiTenant
    {
        ...
        // tambahan
        public TerritoryController([FromServices] IUserRetrieveService userRetriever) : base(userRetriever) { }
