...
using MyRepository = SerenMulti.Northwind.Repositories.ProductLangRepository;
using MyRow = SerenMulti.Northwind.Entities.ProductLangRow;

namespace SerenMulti.Northwind.Endpoints
{
    [Route("Services/Northwind/ProductLang/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class ProductLangController : ServiceEndpointMultiTenant
    {
        ...
        // tambahan
        public ProductLangController([FromServices] IUserRetrieveService userRetriever) : base(userRetriever) { }
