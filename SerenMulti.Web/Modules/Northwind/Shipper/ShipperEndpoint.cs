...
using MyRepository = SerenMulti.Northwind.Repositories.ShipperRepository;
using MyRow = SerenMulti.Northwind.Entities.ShipperRow;

namespace SerenMulti.Northwind.Endpoints
{
    [Route("Services/Northwind/Shipper/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class ShipperController : ServiceEndpointMultiTenant
    {
        ...
        // tambahan
        public ShipperController([FromServices] IUserRetrieveService userRetriever) : base(userRetriever) { }
