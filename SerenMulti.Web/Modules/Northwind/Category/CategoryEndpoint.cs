...
using MyRepository = SerenMulti.Northwind.Repositories.CategoryRepository;
using MyRow = SerenMulti.Northwind.Entities.CategoryRow;

namespace SerenMulti.Northwind.Endpoints
{
    [Route("Services/Northwind/Category/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class CategoryController : ServiceEndpointMultiTenant
    {
        ...
        // tambahan
        public CategoryController([FromServices] IUserRetrieveService userRetriever) : base(userRetriever) { }
