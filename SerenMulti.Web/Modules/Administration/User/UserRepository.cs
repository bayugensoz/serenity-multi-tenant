...
using SerenMulti.Common.Entities;
using System;
...
namespace SerenMulti.Administration.Repositories
{
    public partial class UserRepository : BaseRepositoryMultiTenant
    {
        private static MyRow.RowFields fld { get { return MyRow.Fields; } }
        public static bool IsPublicDemo { get; set; }

        public UserRepository(IRequestContextMultiTenant context) : base(context)
        {
        }
